...
>
> **Status: IMPLEMENTED** — piece 2, commits `0016dae`..`d34997c`. Progress was tracked in the gitignored execution ledger `.superpowers/sdd/2026-09-12-one-flow/progress.md`, not in these checkboxes. Read this plan as the record of what was built, not as work to do.
