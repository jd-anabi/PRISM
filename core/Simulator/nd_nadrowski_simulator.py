...
from core.Models import nd_nadrowski_model
from core.Simulator import simulator

class NDNadrowskiSimulator(simulator.Simulator):
    ...
    def _set_up_model(self):
        try:
            self.sde = nd_nadrowski_model.NDNadrowskiModel(*torch.unbind(self._params, dim=1), self._force, batch_size=self._batch_size, device=self._device, dtype=self._dtype)
